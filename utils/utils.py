...
def compute_loss(p, targets, model):  # predictions, targets, model
    ...
    cp, cn = smooth_BCE(eps=0.0)   # cp = 1, cn = 0.5
    ...
    balance = [1.0, 1.0, 1.0, 1.0]  # anchor = 12
    # balance = [1.0, 1.0, 1.0]   anchor = 9
    for i, pi in enumerate(p):  # layer index, layer predictions
        ...
        if nb:
            ...
            lbox += (1.0 - ciou).sum() if red == 'sum' else (1.0 - ciou).mean()  # ciou loss
